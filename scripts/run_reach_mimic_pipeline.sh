#!/bin/bash
# IsaacLab Mimic Pipeline Script for Reach Task
...
TASK_ANNOTATE="SO-ARM101-Reach-Joint-States-Mimic-v0"

# Generation uses IK Abs env (to output EEF pose actions for IK Abs policy training)
TASK_GENERATE="SO-ARM101-Reach-IK-Abs-Mimic-v0"

INPUT_FILE="./datasets/dataset.hdf5"
ANNOTATED_FILE="./datasets/reach_annotated_dataset.hdf5"
OUTPUT_FILE="./datasets/reach_generated_dataset_ik_abs.hdf5"
DEVICE="cpu"
NUM_ENVS=10
NUM_TRIALS=3

echo "========================================"
echo "IsaacLab Mimic Pipeline - Reach Task"
echo "========================================"
