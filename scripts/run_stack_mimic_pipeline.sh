...
# Merge datasets 1-12 -> annotate with subtask signals (pick_cube, stack_cube)
...
# Component datasets to merge (1-12)
DATASETS=(
...
echo "Input: $INPUT_FILE (merge of datasets 1-12)"
echo "Output: $ANNOTATED_FILE"
echo "========================================"

# Merge datasets 1-7
echo ""
echo "Merging datasets 1-12..."
echo "========================================"
