...
SO_ARM100_ROSCON_CFG = ArticulationCfg(
    spawn=sim_utils.UsdFileCfg(
        usd_path=f"{TEMPLATE_ASSETS_DATA_DIR}/Robots/SO-ARM101-NEW-TF2-nopad.usd",
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            ...
            "jaw_joint": 0.5,  # From real robot ROS2, clamped to limit [-0.175, 1.745]
        },
...
SO_ARM100_ROSCON_HIGH_PD_CFG.actuators["arm"].effort_limit_sim = 5.0
# [Velocity] Set slightly higher to avoid bottleneck, 10 rad/s is fast enough
SO_ARM100_ROSCON_HIGH_PD_CFG.actuators["arm"].velocity_limit_sim = 10.0
...
SO_ARM100_ROSCON_HIGH_PD_CFG.actuators["gripper"].effort_limit_sim = 3.0  # Gripper doesn't need too much force, 3Nm is enough
SO_ARM100_ROSCON_HIGH_PD_CFG.actuators["gripper"].velocity_limit_sim = 10.0
