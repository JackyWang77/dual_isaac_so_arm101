...
from . import mdp, pick_place_joint_pos_env_cfg

##
# Pre-defined configs
##
from SO_100.robots.so_arm100_roscon import SO_ARM100_ROSCON_HIGH_PD_CFG  # isort: skip


@configclass
class DualArmPickPlaceIKAbsEnvCfg(pick_place_joint_pos_env_cfg.DualArmPickPlaceJointPosEnvCfg):
