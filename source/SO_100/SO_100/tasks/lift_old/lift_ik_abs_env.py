...
class SoArm100LiftIKAbsEnv(ManagerBasedRLMimicEnv):
    """Isaac Lab Mimic environment wrapper for SO-ARM100 Lift task with IK Absolute control.
    ...
    def get_robot_eef_pose(self, eef_name: str, env_ids: Sequence[int] | None = None) -> torch.Tensor:
        ...
        # Get EEF pose directly from ee_frame sensor (lift env doesn't have eef_pos/eef_quat in obs)
