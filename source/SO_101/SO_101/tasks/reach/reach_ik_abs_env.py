...
class SoArm100ReachIKAbsEnv(ManagerBasedRLMimicEnv):
    """Isaac Lab Mimic environment wrapper for SO-ARM101 Reach task with IK Absolute control.
    ...
    cfg: SoArm100ReachIKAbsEnvCfg

    def __init__(self, cfg: SoArm100ReachIKAbsEnvCfg, **kwargs):
