...
class ReachCubeGraphDiTRLRunnerCfg(RslRlOnPolicyRunnerCfg):
    ...
    #   2. Full module path "SO_101.policies.graph_dit_rsl_rl_actor_critic.GraphDiTActorCritic"
    ...
    policy = GraphDiTActorCriticCfg(
        ...
        class_name="SO_101.policies.graph_dit_rsl_rl_actor_critic.GraphDiTActorCritic",
