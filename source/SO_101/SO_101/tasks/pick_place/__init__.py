...
# IK Relative Mimic
gym.register(
    id="SO-ARM101-Pick-Place-DualArm-IK-Rel-Mimic-v0",
...
# IK Absolute
gym.register(
    id="SO-ARM101-Pick-Place-DualArm-IK-Abs-v0",
...
gym.register(
    id="SO-ARM101-Pick-Place-IK-Abs-Mimic-v0",
...
# Joint Control for IK Absolute Data Collection
gym.register(
    id="SO-ARM101-Pick-Place-Joint-For-IK-Abs-v0",
...
gym.register(
    id="SO-ARM101-Pick-Place-Joint-For-IK-Abs-Mimic-v0",
...
# Joint States Recording with MimicEnvCfg (records joint states directly, no conversion)
gym.register(
    id="SO-ARM101-Pick-Place-Joint-States-Mimic-v0",
